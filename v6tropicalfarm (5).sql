...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 18 juil. 2023 à 16:03
...
INSERT INTO `basket` (`idbasket`, `id_seller`, `id_buyer`, `id_admin`, `id_item`, `id_session`) VALUES
(1, 0, 0, 0, 10, NULL),
(2, 0, 0, 0, 10, NULL),
(3, 0, 0, 0, 9, NULL),
(4, 0, 0, 0, 9, NULL),
...
(25, 0, 0, 0, 14, NULL),
(26, 0, 0, 0, 14, NULL),
(27, 1, NULL, NULL, 14, NULL),
(28, 1, NULL, NULL, 14, NULL),
(29, 1, NULL, NULL, 14, NULL),
(30, 1, NULL, NULL, 14, NULL),
(31, 1, NULL, NULL, 14, NULL),
(32, 1, NULL, NULL, 14, NULL),
(33, 1, NULL, NULL, 16, NULL),
(34, 1, NULL, NULL, 26, NULL),
(35, 1, NULL, NULL, 19, NULL),
(36, 1, NULL, NULL, 14, NULL),
(37, 1, NULL, NULL, 14, NULL),
(38, 1, NULL, NULL, 25, NULL);
...
(5, 'heloise.maiche@free.fr', '1234', 'visa.png', 'black', 'Héloise M', '', '', '', '', '', '', '', '', '0000-00-00', '', ''),
(3, 'hh', 'hh', 'visa.png', 'red', '', '', '', '', '', '', '', '', '', '0000-00-00', '', ''),
(4, 'j', 'hh', 'visa.png', 'blue', '', '', '', '', '', '', '', '', '', '0000-00-00', '', ''),
(6, 'seller', '1234', 'tortues.png', 'black', '', '', '', '', '', '', '', '', '', '0000-00-00', '', ''),
(7, 'buyer', '1234', 'amphibiens.png', 'darkslategray', 'heloi', 'jduia', 'nsisudh', 'nuihdeuid', 'nuizeud', 'nizjao', '', '', 'nijdae', '05', '2025', 'hgf'),
(8, 'seller2', '1234', 'Aquatic Turtle Food - Maintenance.jpg', 'grey', '', '', '', '', '', '', '', '', '', '0000-00-00', '', '');
...
(1, 'marin.dudouet@gmail.com', '123', 'visa.png', '', 'Marin Dudouet', 'steet', '56', 'london', 'england', '94400', '0787689378', 'visa', '34EI9832948094823', '04', '2023', '454'),
...
(7, 'seller', '1234', 'Boaedon (Lamprophis) fuliginosus, albinos.jpg', 'black', '', '', '', '', '', '', '', '', '', '', '', '');
COMMIT;
